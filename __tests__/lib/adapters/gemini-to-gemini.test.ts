...
describe("Gemini to Gemini Adapter", () => {
  describe("transformRequest", () => {
    it("should return the original request body as is", async () => {
  ...
  describe("transformResponse", () => {
    it("should return the response property of the Gemini result", () => {
      ...
      expect(result).toEqual(geminiResult.response);
    });
  });
